...
import {
  ...
  hostRunnerFactory,
  PnpmPackageManager,
} from "../../src/package-manager/pnpm-package-manager.js";
import type { PnpmRunnerFactory } from "../../src/package-manager/pnpm-package-manager.js";

vi.mock("node:child_process", () => ({
  execFile: vi.fn(),
}));

vi.mock("../../src/package-manager/docker-runner.js", () => ({
...
describe(dockerRunnerFactory, () => {
  it("installLockfileOnly delegates to runCmdForFiles", async () => {
    const { runCmdForFiles: mockRunCmdForFiles } =
      await import("../../src/package-manager/docker-runner.js");
